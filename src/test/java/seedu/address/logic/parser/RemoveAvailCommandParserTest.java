...
public class RemoveAvailCommandParserTest {
    private final RemoveAvailCommandParser parser = new RemoveAvailCommandParser();
    ...
    public void parse_validArgs_success() throws ParseException {
        String userInput;
        RemoveAvailCommand expected;
        RemoveAvailCommand command;

        userInput = INDEX_FIRST_PERSON.getOneBased() + AVAILABILITY_DESC_AMY;
        expected = new RemoveAvailCommand(INDEX_FIRST_PERSON, validAvailabilities);
