...
public class AddAvailCommand extends Command {
    ...
    public static final String MESSAGE_ADD_AVAILABILITY_SUCCESS = "Availability Updated: %1$s";
    public static final String MESSAGE_NOT_ADD_AVAIL = "At least one availability must be provided.";
    public static final String MESSAGE_DUPLICATE_AVAIL = "One of the availability already exists for this person.";
