...
/**
 * Parses input arguments and create a new DeleteAssignmentCommand objectr
 */
public class DeleteAssignmentCommandParser implements Parser<DeleteAssignmentCommand> {

    /**
     * Parses the give {@code String} of arguments in the context of the DeleteAssignmentCommand
